...
// }
  ...
  render() {
    console.log("ChatsContainer", this.props)
    if (!this.props.user) {
    ...
    return (
      <div className="chatsContainer">
        ...
        <Grid.Column width={10} textAlign={"left"}>
          <div>
            <ActiveChatContainer user={this.props.user} chat={this.props.activeChat} messages={this.props.activeChatMessages}  handleNewMessageSubmit={this.props.handleNewMessageSubmit} updateChat={this.props.updateActiveChat} handleCloseChat={this.props.handleCloseChat}/>
          </div>
        </Grid.Column>
